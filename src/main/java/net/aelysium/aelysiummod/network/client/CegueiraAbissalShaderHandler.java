...
public class CegueiraAbissalShaderHandler {

    private static final ResourceLocation SHADER_LOCATION =
            ResourceLocation.fromNamespaceAndPath(AelysiumMod.MOD_ID, "shaders/post/aelysium_cegueira_abissal.json");
    ...
    public static void onClientTick(ClientTickEvent.Post event) {
        ...
        boolean isActive = player != null && player.hasEffect(ModEfeitos.CEGUEIRA_ABISSAL);
    ...
    private static void loadShader(Minecraft mc) {
        ...
        try {
            ...
            org.slf4j.LoggerFactory.getLogger(AelysiumMod.MOD_ID).error("Erro ao carregar shader Cegueira Abissal: ", e);
            activeShader = null;
        }
    }
